...
const Cart = () => {
  const { products, currency,updateQuantity, getCartAmount,cartItems,navigate } = useContext(ShopContext);
  ...
  return (
    <div className="border-t pt-14">
      ...
      <div>
        {cartData.map((item, idx) => {
          ...
          return (
            ...
            >
              ...
              />
              <img className="w-4 sm:w-5 cursor-pointer " 
        ...
        {getCartAmount()>0? <div className="flex justify-end my-20">
